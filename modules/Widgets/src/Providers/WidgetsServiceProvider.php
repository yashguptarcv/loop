...
{
    protected $moduleName = 'Widgets';
    protected $moduleNameLower = 'widgets';
    ...
    public function register(): void
    {
        ...
        $this->app->register(WidgetsEventServiceProvider::class);
    }
    ...
    protected function registerRoutes(): void
    {
        try {
            ...
            \Illuminate\Support\Facades\Log::error("Error in WidgetsServiceProvider registerRoutes: " . $e->getMessage());
            throw $e;
        }
    }
    ...
    {
        $viewPath = resource_path('views/modules/widgets');
        $sourcePath = __DIR__.'/../Resources/views';

        $this->publishes([
            $sourcePath => $viewPath
        ], ['views', 'widgets-module-views']);

        $this->loadViewsFrom($sourcePath, 'widgets');
    }
