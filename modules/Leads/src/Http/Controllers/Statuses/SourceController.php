...
use Modules\Leads\Models\LeadSource as SourceModel;
...
class SourceController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('leads::statuses.sources.index', compact('sources'));
    }

    public function create()
    {
        $sources = SourceModel::all();
        return view('leads::statuses.sources.form', compact('sources'));
    }
    ...
    public function edit($id)
    {
        ...
        if (!$lead) {
            return redirect()->route('admin.statuses.index')->with('error', 'Lead statuses not found.');
        }
        return view('leads::statuses.form', compact('lead'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            return response()->json([
                ...
                'redirect_url' => route('admin.statuses.index'),
                'data' => $user
            ]);
        } catch (\Throwable $e) {
            return response()->json([
