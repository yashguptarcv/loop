...
class InvoiceServiceProvider extends ServiceProvider
{
    ...
    protected function registerRoutes(): void
    {
        try {
            ...
            \Illuminate\Support\Facades\Log::error("Error in InvoiceServiceProvider registerRoutes: " . $e->getMessage());
            throw $e;
        }
    }
    ...
    protected function registerViews(): void
    {
        ...
        $this->publishes([
            $sourcePath => $viewPath
        ], ['views', 'invoice-module-views']);

        $this->loadViewsFrom($sourcePath, 'invoice');
    }
