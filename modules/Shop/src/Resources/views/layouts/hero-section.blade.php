...
<section
  class="relative w-full flex flex-col items-center justify-center text-center hidden lg:flex bg-center bg-cover"
  ...
  <p class="mt-1 mb-0 text-base md:text-xl lg:text-[24px] text-white font-lato"> A Global Tribute in Tbilisi
...
<!-- for mobile screen -->
<section
  class="relative w-full flex flex-col items-start justify-center z-0 text-left px-6 md:px-16 overflow-hidden lg:hidden pt-0 -mt-[10px] bg-center bg-cover"
  style="background-image: url('{{ asset('looplynks/images/HeroSection.png')}}');">
  ...
  <div class="relative z-10 max-w-3xl space-y-4">
    ...
    <p class="text-base md:text-2xl text-white font-normal mt-1 mb-4" style="font-family: 'Lato';"> A
