<div class="mt-8 bg-white shadow rounded-lg overflow-hidden">
    <div class="px-6 py-6">
        <div class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 pt-6 border-t border-gray-200">
                <div class="md:col-span-1">
                    <label for="currency" class="block text-sm font-medium text-gray-700">Admin Currency</label>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 pt-6 border-t border-gray-200">
                <div class="md:col-span-1">
                    <label for="currency" class="block text-sm font-medium text-gray-700">Customer Currency</label>
                    <p class="mt-1 text-sm text-gray-500">Set the currency for financial values.</p>
                </div>
                <div class="md:col-span-2">
                    <select id="currency" name="settings[general.currency.customer]" class="w-full px-3 py-2 border border-gray-300 rounded-md">
                        @foreach (fn_get_currencies() as $currency)
                        <option value="{{ $currency->code }}" {{ old('general.currency.customer', fn_get_setting('general.currency.customer')) == $currency->code ? 'selected' : '' }}>
                            {{ $currency->name }} ({{ $currency->code }})
                        </option>
                        @endforeach
                    </select>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 pt-6 border-t border-gray-200">
                <div class="md:col-span-1">
                    <label for="currency" class="block text-sm font-medium text-gray-700">Language</label>                    
                </div>
                <div class="md:col-span-2">
                    <select id="currency" name="settings[general.language]" class="w-full px-3 py-2 border border-gray-300 rounded-md">                        
                        <option value="en-gb" {{ old('general.language', fn_get_setting('language')) == 'en-gb' ? 'selected' : '' }}>
                            English
                        </option>
                    </select>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 pt-6 border-t border-gray-200">
                <div class="md:col-span-1">
                    <label for="general.tax_applicable" class="block text-sm font-medium text-gray-700">Language</label>                    
                </div>
                <div class="md:col-span-2">
                    <select id="general.tax_applicable" name="settings[general.tax_applicable]" class="w-full px-3 py-2 border border-gray-300 rounded-md">                        
                        <option value="billing" {{ old('general.tax_applicable', fn_get_setting('language')) == 'billing' ? 'selected' : '' }}>
                            Billing
                        </option>
                    </select>
                </div>
