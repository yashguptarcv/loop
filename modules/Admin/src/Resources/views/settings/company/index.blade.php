...
<div class="mt-8 bg-white shadow rounded-lg overflow-hidden">
    <form id="generalForm" class="form-ajax" method="POST"
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="md:col-span-2">
                        <select id="timezone" name="settings[timezone]" class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md">
                    ...
                    <div class="md:col-span-2">
                        <div class="flex space-x-4">
                            <div class="flex items-center">
                                <input id="date-format-1" name="settings[date-format]" type="radio" checked class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300">
                                <label for="date-format-1" class="ml-3 block text-sm font-medium text-gray-700">MM/DD/YYYY</label>
                            </div>
                            <div class="flex items-center">
                                <input id="date-format-2" name="settings[date-format]" type="radio" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300">
                                <label for="date-format-2" class="ml-3 block text-sm font-medium text-gray-700">DD/MM/YYYY</label>
                            </div>
                            <div class="flex items-center">
                                <input id="date-format-3" name="settings[date-format]" type="radio" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 pt-6 border-t border-gray-200">
                    ...
                    <div class="md:col-span-2">
                        <select id="currency" name="settings[currency]" class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md">
                        ...
                        <div class="space-y-4">
                            <div class="flex items-start">
                                <div class="flex items-center h-5">
                                    <input id="new-lead" name="settings[new-lead]" type="checkbox" checked class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded">
                                </div>
                            ...
                            <div class="flex items-start">
                                <div class="flex items-center h-5">
                                    <input id="task-reminders" name="settings[task-reminders]" type="checkbox" checked class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded">
                                </div>
                                <div class="ml-3 text-sm">
                            ...
                            <div class="flex items-start">
                                <div class="flex items-center h-5">
                                    <input id="system-updates" name="settings[system-updates]" type="checkbox" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded">
                                </div>
                                <div class="ml-3 text-sm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 pt-6 border-t border-gray-200">
                    ...
                    <div class="md:col-span-2">
                        <div class="flex items-center">
                            <input type="number" id="data-retention" name="settings[data-retention]" value="365" class="block w-24 rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
