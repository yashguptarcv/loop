...
class CatalogServiceProvider extends ServiceProvider
{
    ...
    protected function registerRoutes(): void
    {
        try {
            ...
            \Illuminate\Support\Facades\Log::error("Error in CatalogServiceProvider registerRoutes: " . $e->getMessage());
            throw $e;
        }
    }
    ...
    protected function registerViews(): void
    {
        ...
        $this->publishes([
            $sourcePath => $viewPath
        ], ['views', 'catalog-module-views']);

        $this->loadViewsFrom($sourcePath, 'catalog');
    }
