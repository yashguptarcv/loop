...
class ShopServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->register(ShopEventServiceProvider::class);
    }
    ...
    protected function registerRoutes(): void
    {
        try {
            ...
            \Illuminate\Support\Facades\Log::error("Error in ShopServiceProvider registerRoutes: " . $e->getMessage());
            throw $e;
        }
    }
    ...
    protected function registerViews(): void
    {
        ...
        $this->loadViewsFrom($sourcePath, 'shop');
    }
