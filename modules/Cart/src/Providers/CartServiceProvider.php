...
class CartServiceProvider extends ServiceProvider
{
    ...
    protected function registerRoutes(): void
    {
        try {
            ...
            \Illuminate\Support\Facades\Log::error("Error in CartServiceProvider registerRoutes: " . $e->getMessage());
            throw $e;
        }
    }
    ...
    protected function registerViews(): void
    {
        ...
        $this->publishes([
            $sourcePath => $viewPath
        ], ['views', 'cart-module-views']);

        $this->loadViewsFrom($sourcePath, 'cart');
    }
