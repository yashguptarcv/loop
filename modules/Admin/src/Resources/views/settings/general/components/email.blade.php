        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 pt-6 border-t border-gray-200">
            ...
            <div class="md:col-span-2">
                <select name="settings[general.mail.encryption]" class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <option value="tls" {{ $selectedDriver == 'tls' ? 'selected' : '' }}>TLS</option>
...
<div class="bg-white shadow rounded-lg overflow-hidden">
    ...
    <div class="px-6 py-6 space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 pt-6 border-t border-gray-200">
            <div class="md:col-span-1">
                <label class="block text-sm font-medium text-gray-700">Add BCC</label>
                <p class="mt-1 text-sm text-gray-500">Use comma separated values to add multiple BCC addresses</p>
            </div>
            <div class="md:col-span-2">
                <input name="settings[general.mail.bcc]" type="text" placeholder="admin@example.com, manager@example.com" class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500" value="{{ old('general.mail.bcc', fn_get_setting('general.mail.bcc')) }}">
            </div>
        </div>
    </div>
</div>
...
<div class="bg-white shadow rounded-lg overflow-hidden">
    <div class="px-6 py-5 border-b border-gray-200">
        ...
        <p class="mt-1 text-sm text-gray-500">Configure your e-mail here to smooth process of order & support</p>
    </div>
    <div class="px-6 py-6">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="md:col-span-1">
            ...
            <div class="md:col-span-2 space-y-4">
                <div>
                    <label for="order_email_nomination" class="block text-sm font-medium text-gray-700 mb-1">Nomination send</label>
                    <input name="settings[general.email.nomination]" value="{{ old('general.email.nomination', fn_get_setting('general.email.nomination')) }}" type="text" id="order_email_nomination" class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                </div>
                <div>
                    <label for="order_creation" class="block text-sm font-medium text-gray-700 mb-1">Order Creation</label>
                    <input name="settings[general.email.order]" value="{{ old('general.email.order', fn_get_setting('general.email.order')) }}" type="text" id="order_creation" class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                </div>
                <div>
                    <label for="promotion" class="block text-sm font-medium text-gray-700 mb-1">Promotion</label>
                    <input name="settings[general.email.promotion]" value="{{ old('general.email.promotion', fn_get_setting('general.email.promotion')) }}" type="text" id="promotion" min="4" max="12" class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">                    
                </div>
                <div>
                    <label for="support" class="block text-sm font-medium text-gray-700 mb-1">Support</label>
                    <input name="settings[general.email.support]" value="{{ old('general.email.support', fn_get_setting('general.email.support')) }}" type="text" id="support" min="4" max="12" class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">                    
                </div>
                <div>
                    <label for="miscellaneous" class="block text-sm font-medium text-gray-700 mb-1">Miscellaneous</label>
                    <input name="settings[general.email.miscellaneous]" value="{{ old('general.email.miscellaneous', fn_get_setting('general.email.miscellaneous')) }}" type="text" id="miscellaneous" min="4" max="12" class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">                    
                </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="md:col-span-2">
                <div class="flex space-x-4">
                    <input name="settings[general.mail.test_mail]" type="text" placeholder="recipient@example.com" class="flex-1 px-4 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
