...
<section class="w-full bg-[#121212] py-8 shadow-2xl">
  <div class="overflow-hidden relative">
    <div id="logo-slider" class="flex items-center space-x-16 animate-logo-scroll w-max">
      ...
      <img src="{{ asset('looplynks/logos/logo-white.png')}}" alt="Logo 2" class="h-10 w-auto opacity-100" />
...
<section class="relative w-full h-screen bg-black/80 z-0 flex items-center justify-center bg-center bg-cover"
  ...
  <div
    ...
    <div class="w-full md:w-1/2 flex-shrink-0">
      <h2
        class="whitespace-nowrap text-4xl sm:text-4xl md:text-5xl lg:text-6xl py-4 font-vegawanty font-semibold text-left gradient-text leading-tight">
        About the program
      </h2>
    </div>
...
<section class="bg-black text-white py-8 z-0 md:py-12 w-full px-4 md:px-[4rem] relative">
...
<div class="event-cards-section bg-center bg-cover bg-no-repeat bg-fixed w-full overflow-hidden"
  style="background-image: url('asset('looplynks/images/Agenda-Event Schedule.png')}}');">
...
<section class="relative overflow-hidden py-24 px-4 sm:px-8 lg:px-24 bg-center bg-no-repeat bg-cover"
  ...
  <div class="max-w-10xl mx-auto block lg:hidden">
    ...
    <!-- Mobile Card Grid -->
    <div class="grid grid-cols- gap-2 px-8">
...
<section class="bg-center bg-cover py-24 px-6 sm:px-8 lg:px-0 min-h-[700px] drop-shadow-lg"
  ...
  <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-[10rem]">
    <!-- Left: Heading -->
    <div>
      <span class="text-white text-base mb-2 block">FAQ</span>
      ...
      <p class="text-gray-300 text-base mb-4">Find quick answers to some of the most common<br> questions about
        LoopLynks. <a href="mailto:info@looplynks.com" class="text-blue-400 underline">Contact Us?</a></p>
    </div>
    <!-- Right: FAQ List -->
    <div>
      <div id="faq-list" class="space-y-6">
        ...
        <div class="pb-2">
          <button class="w-full flex justify-between items-center text-left group" data-faq>
            <span class="text-base font-normal text-white">What Is LoopLynks?</span>
        ...
        <div class="pb-2">
          <button class="w-full flex justify-between items-center text-left group" data-faq>
            <span class="text-base font-normal text-white"> Who Is Eligible To Participate?</span>
            <span class="text-2xl text-white transition-all duration-300">+</span>
          </button>
          <div class="mt-2 text-gray-300 text-base overflow-hidden transition-all duration-500 ease-in-out max-h-0"
            data-faq-content>
        ...
        <div class="pb-2">
          <button class="w-full flex justify-between items-center text-left group" data-faq>
            <span class="text-base font-normal text-white">Do I Have To Pay Any Participation Fee?</span>
            <span class="text-2xl text-white transition-all duration-300">+</span>
          </button>
          <div class="mt-2 text-gray-300 text-base overflow-hidden transition-all duration-500 ease-in-out max-h-0"
            data-faq-content>
        ...
        <div class="pb-2">
          <button class="w-full flex justify-between items-center text-left group" data-faq>
            <span class="text-base font-normal text-white">How Will Winners Be Notified?</span>
            <span class="text-2xl text-white transition-all duration-300">+</span>
          </button>
          <div class="mt-2 text-gray-300 text-base overflow-hidden transition-all duration-500 ease-in-out max-h-0"
            data-faq-content>
        ...
        <div class="pb-2">
          <button class="w-full flex justify-between items-center text-left group" data-faq>
            <span class="text-base font-normal text-white">How can I Connect With The LoopLynks team?</span>
            <span class="text-2xl text-white transition-all duration-300">+</span>
          </button>
          <div class="mt-2 text-gray-300 text-base overflow-hidden transition-all duration-500 ease-in-out max-h-0"
            data-faq-content>
...
<script>
  ...
  window.addEventListener("DOMContentLoaded", () => {
    const firstBtn = document.querySelector('[data-faq]');
    const firstContent = document.querySelector('[data-faq-content]');
    const plusMinus = firstBtn.querySelector('span:last-child');
