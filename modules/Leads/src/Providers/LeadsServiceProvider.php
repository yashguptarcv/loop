...
class LeadsServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->register(LeadsEventServiceProvider::class);
    }
    ...
    protected function registerRoutes(): void
    {
        try {
            ...
            \Illuminate\Support\Facades\Log::error("Error in LeadsServiceProvider registerRoutes: " . $e->getMessage());
            throw $e;
        }
    }
    ...
    protected function registerViews(): void
    {
        ...
        $this->publishes([
            $sourcePath => $viewPath
        ], ['views', 'leads-module-views']);

        $this->loadViewsFrom($sourcePath, 'leads');
    }
